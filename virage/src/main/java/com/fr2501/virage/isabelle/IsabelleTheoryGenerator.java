...
public class IsabelleTheoryGenerator {
  ...
  /**
   * This method takes a Set of {@link CompositionProof} objects and a
   * composition, translates this information to Isabelle syntax and writes its
   * result to a file.
   * 
   ...
   *                    If path points to a file, this file will be overwritten
   *                    and the name will most probably not correspond to the
   *                    theory inside, so Isabelle won't be able to verify it.
   * @return the {@link File} containing the results
   */
  public File generateTheoryFile(String composition, List<CompositionProof> proofs, String outputPath) {
    ...
    Map<String, Set<String>> moduleDefMap = IsabelleUtils.translatePrologToIsabelle(this.functionsAndDefinitions,
        proofPredicate);
    ...
    String fileContents = this.replaceVariables(theoryName, imports, moduleParamTypes, moduleName, moduleParameters,
        moduleDef, proofsString);
  ...
  private String replaceVariables(String theoryName, String imports, String moduleParamTypes, String moduleName,
      String moduleParameters, String moduleDef, String proofs) {
